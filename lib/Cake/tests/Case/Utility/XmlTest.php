 ...
 */
	public function testBuild() {
		...
		$xml = CAKE . 'tests' . DS . 'Fixture' . DS . 'sample.xml';
		$obj = Xml::build($xml);
 ...
 */
	public function testRss() {
		$rss = file_get_contents(CAKE . 'tests' . DS . 'Fixture' . DS . 'rss.xml');
 ...
 */
	public function testSoap() {
		$xmlRequest = Xml::build(CAKE . 'tests' . DS . 'Fixture' . DS . 'soap_request.xml');
		$expected = array(
			'Envelope' => array(
		...
		$xmlResponse = Xml::build(CAKE . 'tests' . DS . 'Fixture' . DS . 'soap_response.xml');
		$expected = array(
			'Envelope' => array(
				'@soap:encodingStyle' => 'http://www.w3.org/2001/12/soap-encoding',
				'soap:Body' => array(
