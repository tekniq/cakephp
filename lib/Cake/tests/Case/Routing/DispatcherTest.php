 ...
 */
	public function testAssets() {
		...
		App::build(array(
			'plugins' => array(CAKE . 'tests' . DS . 'test_app' . DS . 'plugins' . DS),
			'vendors' => array(CAKE . 'tests' . DS . 'test_app' . DS . 'vendors'. DS),
			'View' => array(CAKE . 'tests' . DS . 'test_app' . DS . 'View'. DS)
		));
		...
		$file = file_get_contents(CAKE . 'tests' . DS . 'test_app' . DS . 'View' . DS . 'themed' . DS . 'test_theme' . DS . 'webroot' . DS . 'flash' . DS . 'theme_test.swf');
		...
		$result = ob_get_clean();
		$file = file_get_contents(CAKE . 'tests' . DS . 'test_app' . DS . 'View' . DS . 'themed' . DS . 'test_theme' . DS . 'webroot' . DS . 'pdfs' . DS . 'theme_test.pdf');
		$this->assertEqual($file, $result);
		...
		$result = ob_get_clean();
		$file = file_get_contents(CAKE . 'tests' . DS . 'test_app' . DS . 'View' . DS . 'themed' . DS . 'test_theme' . DS . 'webroot' . DS . 'img' . DS . 'test.jpg');
		$this->assertEqual($file, $result);
		...
		$result = ob_get_clean();
		$expected = file_get_contents(CAKE . 'tests' . DS . 'test_app' . DS . 'plugins' . DS . 'test_plugin' . DS . 'webroot' . DS . 'root.js');
		$this->assertEqual($result, $expected);

		ob_start();
		$Dispatcher->dispatch(new CakeRequest('test_plugin/flash/plugin_test.swf'));
		$result = ob_get_clean();
		$file = file_get_contents(CAKE . 'tests' . DS . 'test_app' . DS . 'plugins' . DS . 'test_plugin' . DS . 'webroot' . DS . 'flash' . DS . 'plugin_test.swf');
		$this->assertEqual($file, $result);
		...
		$result = ob_get_clean();
		$file = file_get_contents(CAKE . 'tests' . DS . 'test_app' . DS . 'plugins' . DS . 'test_plugin' . DS . 'webroot' . DS . 'pdfs' . DS . 'plugin_test.pdf');
		$this->assertEqual($file, $result);
		...
		$result = ob_get_clean();
		$file = file_get_contents(CAKE . 'tests' . DS . 'test_app' . DS . 'plugins' . DS . 'test_plugin' .DS . 'webroot' . DS . 'img' . DS . 'cake.icon.gif');
		$this->assertEqual($file, $result);
